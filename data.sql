-- ================================================================================
-- Punjab Seat Allotment System - Seed Data
-- ================================================================================
-- This file contains all initial data needed for the application to function.
-- Execute this AFTER running schema.sql
--
-- CONTENTS:
-- 1. System settings
-- 2. Central Admin user
-- 3. District Admin users (23 districts)
--
-- CREDENTIALS:
-- - Central Admin: central_admin / admin123
-- - District Admins: admin_[district] / district123
-- ================================================================================
...
INSERT INTO users (
  ...
  first_name, last_name, credentials, is_blocked, created_at, updated_at
) VALUES (
...
-- ================================================================================
-- District Admin Users (23 Districts)
-- Username format: admin_[district] | Password: district123
-- ================================================================================

-- Amritsar
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
) VALUES (
  'vRlz0Y3zy4Kp9tpWbrVil', 'admin_amritsar', 'admin.amritsar@punjab.gov.in',
  '$2b$10$l/t7wKj7Lv6gR3SeRP4cwePfru9zOrnbtPBKgBFnw53OzgVyIXOBO',
  'district_admin', 'Amritsar', 'Amritsar', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  'iCGs2eJGyQlnkeHSWcjvy', 'admin_barnala', 'admin.barnala@punjab.gov.in',
  '$2b$10$poNglQBakD.liFhk37lhO.W/o/gn/Ymc58T4kk.jjWbn2l0GcZKma',
  'district_admin', 'Barnala', 'Barnala', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  'Iuh47pDLnXa6Hb8er1Js9', 'admin_bathinda', 'admin.bathinda@punjab.gov.in',
  '$2b$10$jPBSL6E/lFVgROtLQkYKaeEfv2Az/.Ecqb6imjS0HZ0.gMbLrAedG',
  'district_admin', 'Bathinda', 'Bathinda', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  '-bTmYvVMUb2SKynnrOGCC', 'admin_faridkot', 'admin.faridkot@punjab.gov.in',
  '$2b$10$B0c35A.wsXLv8bHlwkdc5eKQ6vqKjJdDb7Mt78V0V/7D9YB6Pt.cq',
  'district_admin', 'Faridkot', 'Faridkot', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  '1z_RPXnZlwVtcR7NL0cNK', 'admin_fatehgarh_sahib', 'admin.fatehgarhsahib@punjab.gov.in',
  '$2b$10$mCEcIGl69SoMWdgZy4HAL.LX5Xeb1C8QadFiS52CupTf0k7u/y.pW',
  'district_admin', 'Fatehgarh Sahib', 'Fatehgarh Sahib', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  'wfT-1xpB43ZS92b4OUmw6', 'admin_fazilka', 'admin.fazilka@punjab.gov.in',
  '$2b$10$MP3kOlYftrFBG.PJ5I.Kz.BVY4ZxvwB5dGROn0HF70LIXbUNjX.86',
  'district_admin', 'Fazilka', 'Fazilka', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  'q3mGA8_59BYw1xU-1Jtg4', 'admin_ferozepur', 'admin.ferozepur@punjab.gov.in',
  '$2b$10$Z0My9NvvcaAmErf7UzsvkuBeZhUk/ltTSbB5ITrO0YPri3msgu5WO',
  'district_admin', 'Ferozepur', 'Ferozepur', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  'G9ED8hQupO6uG7CVppb-z', 'admin_gurdaspur', 'admin.gurdaspur@punjab.gov.in',
  '$2b$10$PNV8oGQtx1ybhnFUs1TUYurl8SpWF3dQkT.h1pSSfHmNelXrqLMJS',
  'district_admin', 'Gurdaspur', 'Gurdaspur', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  '1J5d2p9T9QnQGV2YLHAfj', 'admin_hoshiarpur', 'admin.hoshiarpur@punjab.gov.in',
  '$2b$10$mO.yF.HiihSfLTYzfdxgf.tfekeP1HQfipX1Y4Qj67It8QKnP7XzW',
  'district_admin', 'Hoshiarpur', 'Hoshiarpur', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  'Dgo1rWGfA_inZy-fTSBhi', 'admin_jalandhar', 'admin.jalandhar@punjab.gov.in',
  '$2b$10$eoirR/iikE0nWkwGQ8uzT.cYdd0tPEb/wrsX1R4Ui4m/LtjTKRdGm',
  'district_admin', 'Jalandhar', 'Jalandhar', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  'tzQT-IYptvK3Wz5Tq2hur', 'admin_kapurthala', 'admin.kapurthala@punjab.gov.in',
  '$2b$10$LEk/P4QAqrmyQxl0TTzvqO0kFF1j8QAbvONkkVgoay7MYe4qDMV.e',
  'district_admin', 'Kapurthala', 'Kapurthala', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  'Enamv5-rC2ICoADdequgO', 'admin_ludhiana', 'admin.ludhiana@punjab.gov.in',
  '$2b$10$7vgF7XpmMWtc.esl0/dqrubc51SOkAnTfQ5PMHz23ihP3Q08ludJy',
  'district_admin', 'Ludhiana', 'Ludhiana', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  'FqJofPkDvp_57Eeqwn9XK', 'admin_mansa', 'admin.mansa@punjab.gov.in',
  '$2b$10$H6dl0ZBu4aw.UzUzBerav.kuCGpbujXw7m2g.srXTKJy5/QuEtDke',
  'district_admin', 'Mansa', 'Mansa', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  '465fY7R7K8OeohSnFFyDU', 'admin_moga', 'admin.moga@punjab.gov.in',
  '$2b$10$L7Ir6W4tbPCr/LrZkdzLTu5/KUUayZn5fqd5kTtlEMs5d2aAzoQR2',
  'district_admin', 'Moga', 'Moga', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  'gQd3tO0JagSTnJ12m_SAT', 'admin_muktsar', 'admin.muktsar@punjab.gov.in',
  '$2b$10$E8XVha3oFW9uE2NCIDdE..eX0zluKYAWnyMhlnbUWTFSNmJoviVXS',
  'district_admin', 'Muktsar', 'Muktsar', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  'rYUnonksd-OkLZsv2p-_d', 'admin_nawanshahr', 'admin.nawanshahr@punjab.gov.in',
  '$2b$10$zPotnFFEsoopkTEicLhj/.lHA6EGOqxhpCzstU1Bq7c3ei1Y.oEky',
  'district_admin', 'Nawanshahr', 'Nawanshahr', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  'YFYxrJZlT1WDMzUCmNxv9', 'admin_pathankot', 'admin.pathankot@punjab.gov.in',
  '$2b$10$n1eGiTuAZWJwTLeT9xkfCekgslERxFGtbhd.SfH/QfR2EWhwVpyVi',
  'district_admin', 'Pathankot', 'Pathankot', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  'IRNSxdOpyD2xsd1E2jKHR', 'admin_patiala', 'admin.patiala@punjab.gov.in',
  '$2b$10$93l2WCEUJjPfxUNSvFR8t.Tko5epsWgeOA8RXRgEhi8e95438raqi',
  'district_admin', 'Patiala', 'Patiala', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  'HtCCM6XSkqiUMUn2hsUZs', 'admin_rupnagar', 'admin.rupnagar@punjab.gov.in',
  '$2b$10$Lon6bo9ZCBivoBfsH6QlGuFM4MhARsnLb9swqmqpEomI98.eNCsMy',
  'district_admin', 'Rupnagar', 'Rupnagar', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  'OH_D_ELVflO43S0WqtEy3', 'admin_sasnagar', 'admin.sasnagar@punjab.gov.in',
  '$2b$10$ThuVY0kZAV9NlvxLYnqIGuTpjTxJwBfOSUPOxLaiYWjlD9NoK7T6.',
  'district_admin', 'SAS Nagar', 'SAS Nagar', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  '9YAEO3QgzmF8ZTP_ULOvC', 'admin_sangrur', 'admin.sangrur@punjab.gov.in',
  '$2b$10$sqdA2oncDJWcIEITAssuF.3lbOY.sT1LVyBg2Gp0JVFMZ9fIGzL.W',
  'district_admin', 'Sangrur', 'Sangrur', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  'lzRmFY31R9rtwEXdo1ScW', 'admin_tarn_taran', 'admin.tarntaran@punjab.gov.in',
  '$2b$10$LCjFckcYKiLsHZe89aSMAOxZsqOgd3VRZH4Q9YaJBtP5RRQI1rftG',
  'district_admin', 'Tarn Taran', 'Tarn Taran', 'Admin',
...
INSERT INTO users (id, username, email, password, role, district, first_name, last_name, credentials, is_blocked, created_at, updated_at
  ...
  'QMpOk7slFMZLAs1nLifm-', 'admin_talwara', 'admin.talwara@punjab.gov.in',
  '$2b$10$/SefED03GtfyfnQUl14IT.BNBwJinLglyx9v3EJNwLaHJuumiWq.i',
  'district_admin', 'Talwara', 'Talwara', 'Admin',
...
-- To login:
-- - Central Admin: central_admin / admin123
-- - District Admin: admin_[district] / district123
-- ================================================================================
